...
\DefineVerbatimEnvironment{verbatim}{Verbatim}{frame=leftline,framerule=0.5pt,framesep=0.4em,numbers=left,numbersep=0.5em,stepnumber=1,numberblanklines=true,fontsize=\relsize{-3}}
...
$endif$
$if(license)$
\copyrightetc{$license$ $for(author)$ $author.name$ $endfor$ $conference_date$}
$endif$
